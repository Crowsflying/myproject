  ...
  <ul>
   <li>
    <table class="price_table">
     <caption>
      <strong>询价单号：${oneInquiry.inquiryid}</strong>
      <strong>报价日期：<time>${oneInquiry.time}</time></strong>
      <strong>报价公司：***服装有限公司</strong>
      <strong>在线联系</strong>
     </caption>
     <tr>
      <th>序号</th>
     ...
     <tr>
      <td class="center">${oneInquiry.inquiryid}</td>
      <td>${oneInquiry.configure}</td>
      <td>${oneInquiry.material}</td>
      <td>${oneInquiry.type}</td>
      <td class="center">${oneInquiry.thickness}</td>
      <td>${oneInquiry.color}</td>
      <td>${oneInquiry.working}</td>
      <td class="center">${oneInquiry.num}</td>
      <td class="center rmb_icon">${oneInquiry.price}</td>
      <td class="center">
     ...
     <tr>
      ...
      <td class="center rmb_icon">${oneInquiry.num*oneInquiry.price}</td>
      <td class="center"><input type="button"  value="确认购买"/></td>
