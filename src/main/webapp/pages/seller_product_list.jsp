...
<section class="wrap user_center_wrap">
 ...
 <div class="user_rt_cont">
  <div class="top_title">
   <strong>商品列表</strong>
   <a href="seller_product_detail.jsp" title="添加新商品" class="fr">添加新商品</a>
  </div>
  <!--条件检索-->
  ...
  <table class="order_table">
   ...
   <tr>
    ...
    <td class="center">
     ...
     <a href="seller_product_detail.jsp" title="编辑"><img src="../images/icon_edit.gif"/></a>
     <a title="删除"><img src="../images/icon_trash.gif"/></a>
    </td>
   </tr>
   <tr>
    <td class="center">A880936</td>
    <td class="center"><a href="product.jsp" target="_blank"><img src="../upload/goods010.jpg" width="50" height="50"/></a></td>
    <td><a href="product.jsp" target="_blank">这里是产品名称哦</a></td>
