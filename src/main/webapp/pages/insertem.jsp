...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
          <form id="tab" action="${pageContext.request.contextPath}/user/insertEm.do">
              <label>Username</label>
              <input type="text" value="jsmith" class="input-xlarge" name="username">
              <label>First Name</label>
              <input type="text" value="John" class="input-xlarge" name="firstname">
              <label>Last Name</label>
              <input type="text" value="Smith" class="input-xlarge" name="lastname">
              <label>Email</label>
              <input type="text" value="jsmith@yourcompany.com" class="input-xlarge" name="email">
              <label>Address</label>
              <input type="text" value="Aris sdtvDrf Prdgvcr" class="input-xlarge" name="address">
              <label></label>
