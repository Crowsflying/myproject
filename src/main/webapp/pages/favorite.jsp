...
<section class="wrap user_center_wrap">
 ...
 <div class="user_rt_cont">
  ...
  <ul class="favorite_list">
   <c:forEach var="collect" items="${pageInfo.list}">
   <li>
    <a href="${pageContext.request.contextPath}/clothes/findmaninfo.do?type=0&&name=${collect.collectname}">
     <img src="http://q28msmys0.bkt.clouddn.com/${collect.image}"/>
     <h2>${collect.collectname}</h2>
     <p class="price"><span class="rmb_icon">${collect.price}</span></p>
     <p class="remove"><a href="${pageContext.request.contextPath}/onself/deletecollect.do?id=${collect.collectid}"><span>&#126;</span></a></p>
    </a>
   </li>
   </c:forEach>
  </ul>
   <!--分页-->
   <div class="paging">
    <a href="${pageContext.request.contextPath}/onself/findcollect.do?currentpage=1"><<</a>
    <c:forEach var="i" begin="1" end="${pageInfo.pages}">
     <a href="${pageContext.request.contextPath}/onself/findcollect.do?currentpage=${i}">${i}</a>
    </c:forEach>
    <a href="${pageContext.request.contextPath}/onself/findcollect.do?currentpage=${pageInfo.pages}">>></a>
   </div>
  </div>
  <!--店铺收藏-->
  <div class="favoriteWrap">
  <ul class="favorite_list">
   <c:forEach items="${pageInfo1.list}" var="collectbrand">
   <li>
    <a>
     <img src="http://q28msmys0.bkt.clouddn.com/${collectbrand.brandimage}"/>
     <h2>${collectbrand.brandname}</h2>
     <p class="remove"><a href="${pageContext.request.contextPath}/onself/deletecollectbrand.do?id=${collectbrand.brandid}"><span>&#126;</span></a></p>
    </a>
   </li>
   </c:forEach>
  </ul>
