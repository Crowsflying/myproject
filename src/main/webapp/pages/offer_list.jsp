   ...
   <li>
    <table class="price_table">
     ...
     <tr>
      ...
      <td>磨破</td>
      <td class="center">2</td>
      <td class="center"><input type="button" value="我要报价" onClick="javascript:location.href='offer_detail.jsp'"/></td>
     </tr>
    </table>
   </li>
   <li>
    <table class="price_table">
     ...
     <tr>
      ...
      <td>磨破</td>
      <td class="center">2</td>
      <td class="center"><input type="button" onClick="javascript:location.href='offer_detail.jsp'" value="我要报价"/></td>
     </tr>
    </table>
   </li>
  </ul>
