 ...
 <div class="user_rt_cont">
  ...
  <table class="order_table">
   <tr>
    ...
    <td><input type="password" class="textbox" id="oldpassword"/><mark class="tips_errors">请填写原密码</mark></td>
   </tr>
   <tr>
    <td width="80" align="right">设置新密码：</td>
    <td><input type="password" class="textbox" id="newpassword"/><mark class="tips_errors">请填写新密码</mark></td>
   </tr>
   <tr>
    <td width="80" align="right">确认新密码：</td>
    <td><input type="password" class="textbox" id="renewpassword"/><mark class="tips_errors">确认新密码</mark></td>
   </tr>
   <tr>
...
<script type="text/javascript">
 $(".group_btn").on("click",function () {
     ...
     $.ajax({
         url:"${pageContext.request.contextPath}/clothes/updatapassword.do",
         type:"post",
         dataType:"json",
         data:{
             password:password,
