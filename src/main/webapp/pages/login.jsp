...
<section class="wrap user_form">
 ...
 <div class="rt_form">
  <h2>会员登录</h2>
  <ul>
   <li class="user_icon" style="height: 30px">
    <input  type="text" class="textbox" placeholder="账号" id="username"/>
   </li>
    </br>
   <li class="user_pwd">
...
<script type="text/javascript">
 $(function () {
     $(".sbmt_btn").on("click",function () {
         ...
         $.ajax({
             url:"${pageContext.request.contextPath}/clothes/login.do",
             type:"post",
             dataType:"json",
             data:{
                 username:username,
             ...
             success:function (data) {
                  if (data.result==0) {
                      ...
                      window.location.href="${pageContext.request.contextPath}/clothes/findmain.do"
                  }
             }
