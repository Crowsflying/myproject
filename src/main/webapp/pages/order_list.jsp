...
<section class="wrap user_center_wrap">
 ...
 <div class="user_rt_cont">
  ...
  <div style="margin:8px 0;">
   ...
   <form action="${pageContext.request.contextPath}/order/orderfind.do" method="post">
   <input type="text" class="textbox textbox_225" placeholder="输入订单编号" name="search"/>
  ...
  <ul class="order_li">
   ...
   <li>
    <table class="order_table">
     <caption>
      ...
      <a href="${pageContext.request.contextPath}/order/orderdetailed.do?orderid=${order.orderid}">订单详情</a>
     </caption>
     <tr>
      <td class="center"><a href="${pageContext.request.contextPath}/clothes/findmaninfo.do?name=${order.name}"><img src="http://q28msmys0.bkt.clouddn.com/${order.image}" style="width:50px;height:50px;"/></a></td>
      <td><a href="product.jsp">${order.name}</a></td>
      <td class="center"><span class="rmb_icon">${order.price}</span></td>
      <td class="center"><b>${order.nums}</b></td>
      <td class="center"><strong class="rmb_icon">${order.price*order.nums}</strong></td>
      <td class="center"><a class="a_btn">付款完成</a></td>
     </tr>
    </table>
   </li>
   </c:forEach>
   ...
   <div class="paging" style="text-align:right">
    <a href="${pageContext.request.contextPath}/order/orderfind.do?currentpage=1">第一页</a>
    <c:forEach var="i" begin="1" end="${pageInfo.pages}">
     <a href="${pageContext.request.contextPath}/order/orderfind.do?currentpage=${i}">${i}</a>
    </c:forEach>
    <a href="${pageContext.request.contextPath}/order/orderfind.do?currentpage=${pageInfo.pages}">最后一页</a>
   </div>
 </div>
</section>
<!--footer-->
