  ...
  <dl class="order_cmt">
   ...
   <dd>
      <table class="order_table">
       <tr>
        <td class="center" width="70"><a href="product.jsp" target="_blank"><img src="upload/goods009.jpg" width="50" height="50"/></a></td>
        <td width="300"><a h href="product.jsp" target="_blank">这里是产品名称哦</a></td>
