...
<aside class="wrap insideLink">
  ...
  <a href="article_list.jsp">教育频道</a>
</aside>
<section class="wrap atc_list">
 <div class="atc_rd">
  ...
  <div class="file_btm">
   <p>下载文档到电脑，查找使用更方便</p>
   <p><a href="#" class="dl_btn">下载</a></p>
  </div>
 </div>
 <aside>
  <a class="upload_btn" style="margin-bottom:8px;">上传文档</a>
  <!--相关文章-->
  <div class="rlvt_atc">
   <h3>相关文档推荐</h3>
   <ul>
    <li><a href="reading.jsp" class="rl_fie word_ico">组图：巨型乌木根雕《清明上河图》亮相深圳</a></li>
    <li><a href="reading.jsp" class="rl_fie excel_ico">习近平陪同莫迪参观大雁塔 莫迪赠送菩提树</a></li>
    <li><a href="reading.jsp" class="rl_fie ppt_ico">载40人旅游大巴在陕西咸阳坠入山沟 已35人</a></li>
    <li><a href="reading.jsp" class="rl_fie excel_ico">国务院部署宽带降费提速 运营商今公布新方</a></li>
    <li><a href="reading.jsp" class="rl_fie excel_ico">贵州惠水一公职人员死于家中 胃内发现71枚硬币</a></li>
    <li><a href="reading.jsp" class="rl_fie word_ico">缅甸两枚炮弹再次落入中国云南境内 致4人受</a></li>
    <li><a href="reading.jsp" class="rl_fie word_ico">三大运营商公布提速降费方案 资费最高降35%</a></li>
    <li><a href="reading.jsp" class="rl_fie ppt_ico">合肥少女被毁容案宣判 受害少女周岩获赔172</a></li>
    <li><a href="reading.jsp" class="rl_fie ppt_ico">马英九引三国论两岸关系：天下大势分久必合</a></li>
    <li><a href="reading.jsp" class="rl_fie word_ico">李克强：机关事业单位工资6月底前调整到位</a></li>
   </ul>
  </div>
 </aside>
</section>
