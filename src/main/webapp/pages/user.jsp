...
<section class="wrap user_center_wrap">
 ...
 <div class="user_rt_cont">
  <div class="top_title">
   <strong><em><%=user.getTruename()%></em>欢迎回到用户中心</strong>
  </div>
  <!--用户信息-->
  <div class="user_factbook">
   <a href="profile.jsp" class="user_icon">
    <img src="http://q28msmys0.bkt.clouddn.com/<%=user.getHeadimage()%>"/>
    <span>修改头像</span>
   </a>
   <div class="user_infor">
    <p><strong><%=user.getNickname()%></strong>（商户会员）<span class="user_vip unaccredited">未认证！</span><a href="authenticate.jsp">申请入驻</a></p><!--**未认证的class值为"unaccredited"**-->
    <p>上次登录时间：<time>2013-01-14 13:55</time>，登录ip：192.168.1.1</p>
    <p>账户余额：<strong class="rmb_icon"><%=user.getBalance()%></strong><a href="${pageContext.request.contextPath}/onself/findaccount.do" class="btn">充值</a><a href="${pageContext.request.contextPath}/onself/findaccount.do" class="btn">提现</a></p>
   </div>
  </div>
  <!--买家订单提醒-->
  <dl class="user_order_tips">
   <dt>买家订单提醒</dt>
   <dd>
    <a href="${pageContext.request.contextPath}/order/orderfind.do">
     <strong>20</strong>
     <em>待付款订单</em>
    </a>
   </dd>
