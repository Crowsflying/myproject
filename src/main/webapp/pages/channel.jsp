 ...
 <aside>
  <dl class="aside_pro_list">
   ...
   <c:forEach var="boutique" items="${boutique}">
    <dd>
     <a href="#" class="goods_img"><img src="http://q28msmys0.bkt.clouddn.com/${boutique.images}"/></a>
     <div class="rt_infor">
      <h3><a href="#">${boutique.clothesname}</a></h3>
      <p><del class="rmb_icon">${boutique.price*1.2+100}</del></p>
