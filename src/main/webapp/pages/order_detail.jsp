...
<section class="wrap user_center_wrap">
 ...
 <div class="user_rt_cont">
  <div class="top_title">
   <strong>订单：${orderdetailed.orderid}</strong>
  </div>
  <dl class="order_detail_infor">
   <dt>订单信息</dt>
   <dd><span>下单时间：</span>${orderdetailed.ordertime}</dd>
   <dd><span>付款时间：</span>${orderdetailed.ordertime}</dd>
   <dd><span>订单状态：</span>付款完成</dd>
   <dd><span>收件人：</span><%=user.getTruename()%></dd>
   <dd><span>联系电话：</span><%=user.getPhone()%></dd>
   <dd><span>收件地址：</span>中软国际宁波镇海区</dd>
  </dl>
  <dl class="order_detail_infor">
   <dt>订单留言</dt>
   <dd style="color:red;">帮我检查好呀谢谢^_^</dd>
  </dl>
    <table class="order_table">
     <caption><strong>订单商品</strong><span class="fr">订单合计金额：<b class="rmb_icon">${orderdetailed.price*orderdetailed.nums}</b> 配送费用：<b class="rmb_icon">0.00</b></span></caption>
     <tr>
      <th>产品图</th>
      <th>产品名</th>
      <th>单价</th>
     ...
     <tr>
      <td class="center"><a href="${pageContext.request.contextPath}/clothes/findmaninfo.do?name=${orderdetailed.name}"><img src="http://q28msmys0.bkt.clouddn.com/${orderdetailed.image}" style="width:50px;height:50px;"/></a></td>
      <td><a href="${pageContext.request.contextPath}/clothes/findmaninfo.do?name=${orderdetailed.name}">${orderdetailed.name}</a></td>
      <td class="center"><span class="rmb_icon">${orderdetailed.price}</span></td>
      <td class="center"><b>${orderdetailed.nums}</b></td>
      <td class="center"><strong class="rmb_icon">${orderdetailed.price*orderdetailed.nums}</strong></td>
     </tr>
    </table>
 </div>
</section>
