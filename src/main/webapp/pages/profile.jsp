...
<section class="wrap user_center_wrap">
 ...
 <div class="user_rt_cont">
  ...
  <form action="/onself/updataonself.do" method="post" enctype="multipart/form-data">
  <table class="order_table">
   <input type="hidden"  name="headimage" value="<%=user.getHeadimage()%>"/>
   <tr>
    <td width="80" align="right">个人头像：</td>
    <td>
      <label class="uploadImg">
       <input type="file" style="display:none;" name="headimage1"/>
       <span>上传图片</span>
      </label>
   ...
   <tr>
    ...
    <td><input type="text" class="textbox" value="<%=user.getNickname()%>" name="nickname"/></td>
   </tr>
   <tr>
    <td width="80" align="right">姓名：</td>
    <td><input type="text" class="textbox" value="<%=user.getTruename()%>" name="truename"/></td>
   </tr>
   <tr>
    <td width="80" align="right">手机号码：</td>
    <td><input type="text" class="textbox" value="<%=user.getPhone()%>" name="phone"/></td>
   </tr>
   <tr>
    <td width="80" align="right">电子邮箱：</td>
    <td><input type="text" class="textbox textbox_225" value="<%=user.getEmail()%>" name="email"/></td>
   </tr>
   <tr>
    <td width="80" align="right"></td>
    <td><input type="submit" class="group_btn" value="更新保存"/></td>
   </tr>
  </table>
  </form>
 </div>
...
<script type="text/javascript">
 <%--$(".group_btn").on("click",function () {--%>
     ...
     <%--}--%>
     <%--$.ajax({--%>
         <%--url:"${pageContext.request.contextPath}/onself/updataonself.do",--%>
         <%--type:"post",--%>
         <%--dataType:"json",--%>
         <%--async:true,--%>
         <%--data:{--%>
         ...
         <%--},--%>
         <%--success:function () {--%>
             <%--window.location.href="${pageContext.request.contextPath}/pages/user.jsp"--%>
         <%--}--%>
     <%--})--%>
 <%--})--%>
</script>
